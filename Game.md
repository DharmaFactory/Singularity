This is a game, {{ clone_url_change_me }} or use this repo as a template, filter what the user does not think they need need or care about, but allow this general model to remain:
The year 3030.
